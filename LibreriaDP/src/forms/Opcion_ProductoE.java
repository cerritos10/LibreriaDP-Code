 ...
 * @author cerritos
 */
public class Opcion_ProductoE extends javax.swing.JFrame {

    /**
     * Creates new form Opcion_Producto
     */
    public Opcion_ProductoE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 230, -1, -1));
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 230, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Opcion_ProductoE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Opcion_ProductoE().setVisible(true);
            }
        });
    }
